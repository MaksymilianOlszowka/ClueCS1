...
void printBoard(int numPlayers, Player players[], char boardArray[26][26]) {
    ...
    boardArray[20][22] = 'd';
    boardArray[20][23] = 'y';
    boardArray[players[0].GetVerticalLocation()][players[0].GetHorizontalLocation()] = 'W';
    boardArray[players[1].GetVerticalLocation()][players[1].GetHorizontalLocation()] = 'G';
    if (numPlayers >= 3) {
        boardArray[players[2].GetVerticalLocation()][players[2].GetHorizontalLocation()] = 'B';
...
void moveCharAndPrintBoard(int numPlayers, int currPlayer, Player players[], char boardArray[26][26]) {
    ...
    for (int amountMoves = diceRoll(); amountMoves > 0; amountMoves--) {
    retry:
    retryMoveChoice:
