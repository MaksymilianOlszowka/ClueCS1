...
bool finalAccusation(string caseFile[3], Player players[], int currPlayer) {
...
retryUsrChoice:
    ...
    if ((caseFile[0] == characters[accusedCharacter - 1]) && (caseFile[1] == weapons[accusedWeapon - 1]) && (caseFile[2] == locations[accusedLocation - 1])) {
        cout << "\nYou win!\n\n";
        return win = true;
