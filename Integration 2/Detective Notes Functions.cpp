...
void Player::EditDetectiveNotes(int currPlayer, Player players[]) {
    int usrChoice, usrChoice2; // For detective notes list navigation
    char usrChoice3;           // For marking an 'X' or 'O' on the detective notes
    char extChoice = '\0';     // Used to determine if player wants to mark more notes or exit the notes
    ...
    retry:
        ...
        if ((usrChoice < 1) || (usrChoice > 4)) {
            cout << "\nNot a valid choice\n\n";
            goto retry; // Sends player to line 21
            
        }
        if (usrChoice == 4) { // To skip marking notes and just print notes instead
            goto print; // Sends player to line 509
        ...
        switch (usrChoice) {
            case 1:
                ...
                retryUsrChoice2Char:
                    ...
                    if ((usrChoice2 < 1) || (usrChoice2 > 7)) {
                        cout << "\nNot a valid choice\n\n";
                        goto retryUsrChoice2Char; // Sends player to line 43
                    ...
                    switch (usrChoice2) {
                        case 1:
                            cout << "X or O? : ";
                            cin >> usrChoice3;
                            usrChoice3 = toupper(usrChoice3); // Negates case-sensitivity in user input
                            if (usrChoice3 == 'X') {
                                colMust = 'X';
                                break;
                ...
                while (usrChoice2 != 7); // Allows player to continuously mark same catagory until they move to the next one
            case 2:
                do {
                retryUsrChoice2Weap:
                    ...
                    if ((usrChoice2 < 1) || (usrChoice2 > 7)) {
                        cout << "\nNot a valid choice\n\n";
                        goto retryUsrChoice2Weap; // Sends player to line 176
            ...
            case 3:
                ...
                retryUsrChoice2Loc:
                    ...
                    if ((usrChoice2 < 1) || (usrChoice2 > 10)) {
                        cout << "\nNot a valid choice\n\n";
                        goto retryUsrChoice2Loc; // Sends player to line 309
            ...
            retryExtChoice:
                ...
                if ((extChoice != 'y') && (extChoice != 'n')) {
                    cout << "\n\nNot a valid input.\n\n";
                    goto retryExtChoice; // Sends player to line 496
                    
                }
        }
    }
    while (extChoice == 'y'); // Keeps running the switch statements until the player inputs 'n' for extChoice
...
void Player::PrintDetectiveNotes(Player players[], int currPlayer) {
    ...
    players[currPlayer].GetPlayerHand(); // Shows current player hand everytime notes are printed. Quality of life feature
